        ...
        for (int i = 0; i < array1.length; i++) {
            for (String a : array2) {
                ...
                */
                ...
                /*
                В решении все проще, проверки с null нет, просто сравнение сделано наоборот
                a.equals(array1[i]) т.к. а никогда не примет значение null, но мой вариант тоже вполне рабочий....
                 */
